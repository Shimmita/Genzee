...
export default function DownloadPageTabs() {
    ...
    <Box>
      <>
        <div className="d-flex justify-align-content-between w-100 align-items-center">
          ...
          >
            Download Android or IOS Application
          </Typography>
          {/* close the window */}
        ...
        <Box className="border-bottom p-0 d-flex justify-content-center align-items-center">
          ...
          >
            <StyledTab
              label={<Typography variant="body2">android</Typography>}
            />
            <StyledTab label={<Typography variant="body2">ios</Typography>} />

            <StyledTab label={<Typography variant="body2">compatible</Typography>} />
          </StyledTabs>
        </Box>
      </>
